            ...
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
               <div className="space-y-2 group">
                  ...
                  <input 
                    ...
                    className="w-full border-b-2 border-zinc-100 py-4 outline-none focus:border-black transition-all text-[13px] font-black italic placeholder:text-zinc-200 placeholder:italic uppercase tracking-widest"
                  />
               </div>
               ...
               <div className="space-y-2 group relative">
                  ...
                  <input 
                    ...
                    onChange={sanitizeInput}
                    placeholder="••••••••"
                    className="w-full border-b-2 border-zinc-100 py-4 outline-none focus:border-black transition-all text-[13px] font-black italic placeholder:text-zinc-200 transition-all uppercase tracking-[0.5em]"
                  />
                  <button 
                    type="button"
               ...
               <div className="pt-6 space-y-8">
                  <button className="w-full bg-black text-white py-6 flex items-center justify-center gap-5 group overflow-hidden relative active:scale-[0.98] transition-transform shadow-xl">
                     <span className="text-[12px] font-black uppercase tracking-[0.3em] italic relative z-10 group-hover:-translate-y-12 transition-transform duration-500">Authorize Access</span>
                     <span className="text-[12px] font-black uppercase tracking-[0.3em] italic absolute translate-y-12 group-hover:translate-y-0 transition-transform duration-500">Processing...</span>
